    ...
    <LinearGradient colors={[colors.canvas, colors.lavenderSoft, colors.coralSoft]} style={{ flex: 1 }}>
      <ScrollView contentInsetAdjustmentBehavior="automatic" contentContainerStyle={{ flexGrow: 1, width: '100%', maxWidth: 620, alignSelf: 'center', paddingHorizontal: 22, paddingTop: 42, paddingBottom: 34, justifyContent: 'space-between', gap: 24 }}>
        ...
        <Card style={{ alignItems: 'center', paddingVertical: 38, paddingHorizontal: 24 }}>
          {step === 0 ? <Image source={require('../assets/illustrations/glitter-garden-hero.png')} accessibilityLabel="A smiling flower in Glitter's rainbow garden beside a private school pouch" contentFit="cover" style={{ width: '100%', aspectRatio: 1.5, borderRadius: radii.medium }} /> : <GardenGlyph name={current.icon} size={62} />}
